...
export { Controller } from './Controller.component';
export { Colorful } from './Colorful.component';
export { MagicEightBall } from './MagicEightBall.component';
export { MyComponent as MyComponent07 } from './MyComponent07.component';
export { CheckUserAge } from './CheckUserAge.component';
export { GameOfChance } from './GameOfChange.component';
export { GateKeeper } from './GateKeeper.component';
export { MyToDoList } from './MyToDoList.component';
export { MyComponent as MyComponent08 } from './MyComponent08.component';